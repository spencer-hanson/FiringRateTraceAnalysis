...
class CustomUnitFilter(UnitFilter):
    def __init__(self, spike_count_threshold, trial_threshold, missing_threshold, min_missing,
        baseline_mean_zscore, baseline_time_std_zscore):
        ...
        super().__init__(passing_func, num_units)  # TODO
